...
const SuccessScreen: React.FC<SuccessScreenProps> = ({ userName, onRestart }) => {
  return (
    <GlassCard className="text-center w-full max-w-2xl animate-scale-in">
      ...
      <p className="text-lg text-gray-200 mb-6">You passed the coding test.</p>
      
      <div className="my-8">
        <p className="text-md text-gray-300">Here's your secret reward:</p>
        <a 
